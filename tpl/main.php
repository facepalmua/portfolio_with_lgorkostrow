    ...
    <div class=" wow fadeInRight stn-portfolio" data-wow-offset="300">
        <section class="container tab-wrapper">
            <ul class="horizontal-nav black-font tab-menu">
                <li><a class="site active">All</a></li>
                <li><a class="site">Landing page</a></li>
                <li><a class="site">Интернет магазин</a></li>
                <li><a class="site">Корпоративный сайт</a></li>
                <li><a class="site">Визитка</a></li>
            </ul>
            <h2 class="stn-heading black-line"><a name="Portfolio" id="Portfolio"></a>Portfolio</h2>
            <div class="row thumbs-row">
                <?php foreach($this->site_all as $s) : ?>
                    <div class="col-sm-6 col-md-3">
                        <a href="<?=$s['site']?>" class="thumb-1"><img src="uploads/<?=$s['img']?>" class="thumb-0" alt="img"></a>
                    </div>
                <?php endforeach ?>
            ...
            <!-- ///row -->
             <div class="row thumbs-row">
                 <?php foreach($this->site_Landing as $s) : ?>
                     <div class="col-sm-6 col-md-3">
                         <a href="<?=$s['site']?>" class="thumb-1"><img src="uploads/<?=$s['img']?>" class="thumb-0" alt="img"></a>
                     </div>
                 <?php endforeach ?>
            ...
            <div class="row thumbs-row">
                <?php foreach($this->site_shop as $s) : ?>
                    <div class="col-sm-6 col-md-3">
                        <a href="<?=$s['site']?>" class="thumb-1"><img src="uploads/<?=$s['img']?>" class="thumb-0" alt="img"></a>
                    </div>
                <?php endforeach ?>
            ...
            <div class="row thumbs-row">
                <?php foreach($this->site_corp as $s) : ?>
                    <div class="col-sm-6 col-md-3">
                        <a href="<?=$s['site']?>" class="thumb-1"><img src="uploads/<?=$s['img']?>" class="thumb-0" alt="img"></a>
                    </div>
                <?php endforeach ?>
            ...
            <div class="row thumbs-row">
                <?php foreach($this->site_cutaway as $s) : ?>
                    <div class="col-sm-6 col-md-3">
                        <a href="<?=$s['site']?>" class="thumb-1"><img src="uploads/<?=$s['img']?>" class="thumb-0" alt="img"></a>
                    </div>
                <?php endforeach ?>
